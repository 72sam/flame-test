 ...
 function livelyPropertyListener(name, val) {
  switch (name) {
    ...
    case "quality":
      switch (val) {
        ...
        case 4: 
          ...
          generateColor = () => {
            const palette = [
              { r: 235 * 0.1, g:  80 * 0.1, b:  45 * 0.1 },
              { r: 245 * 0.1, g: 175 * 0.1, b:  30 * 0.1 },
              { r:  30 * 0.1, g:  60 * 0.1, b: 140 * 0.1 }
            ];
    ...
    case "simResolution":
      switch (val) {
        case 0: config.SIM_RESOLUTION = 32;  break;
        case 1: config.SIM_RESOLUTION = 64;  break;
        case 2: config.SIM_RESOLUTION = 128; break;
        case 3: config.SIM_RESOLUTION = 256; break;
      }
      initFramebuffers();
      break;

    // Diffusione e dissipazione
    ...
    // Parametri di pressione e vorticità
    case "pressure":
